...
public class ScanInventoryTagContext {
    ...
    public BigDecimal getLineReceivedQty() { return lineReceivedQty; }
    public void setLineReceivedQty(BigDecimal lineReceivedQty) { this.lineReceivedQty = lineReceivedQty; }
    ...
    public Long getLocationWarehouseId() { return locationWarehouseId; }
    public void setLocationWarehouseId(Long locationWarehouseId) { this.locationWarehouseId = locationWarehouseId; }
    ...
    public String getActiveHoldType() { return activeHoldType; }
    public void setActiveHoldType(String activeHoldType) { this.activeHoldType = activeHoldType; }
    public String getActiveHoldReason() { return activeHoldReason; }
    public void setActiveHoldReason(String activeHoldReason) { this.activeHoldReason = activeHoldReason; }
    public String getActiveHoldRemark() { return activeHoldRemark; }
    public void setActiveHoldRemark(String activeHoldRemark) { this.activeHoldRemark = activeHoldRemark; }
}
